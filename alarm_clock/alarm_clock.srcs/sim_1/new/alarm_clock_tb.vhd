...
begin
    ...
    begin
        ...
        -- 5. Decreases timer by a minute (00:00:03)
        sig_dec <= '1'; wait for clk_period; sig_dec <= '0'; wait for 50 ns;

        -- 6. Start the countdown
        sig_play_pause <= '1'; wait for clk_period; sig_play_pause <= '0'; wait for 50 ns;

        -- 7. Artificially accelerate time!
        -- Instead of waiting 100,000,000 clock cycles, we just pulse ce_1hz 64 times.
        -- This will run a 4 "second" countdown in just over 1,000 nanoseconds.
        for i in 1 to 4 loop
            ce_1hz <= '1'; wait for clk_period;
            ce_1hz <= '0'; wait for 10 ns;
        end loop;
