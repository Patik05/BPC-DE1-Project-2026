        ...
        if rising_edge(clk) then
            if rst = '1' then
                ...
                if ce_sample = '1' then
                    ...
                    -- There are ones or zeros into a 4-bit memory until its it completely connected (each period, change of a bit). We want either
                    -- full 1s or 0s to make sure the button does not bounce more
